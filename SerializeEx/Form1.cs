...
namespace SerializeEx
{
    public partial class Form1 : Form
    {
        ...
        {
            FileStream fs = new FileStream(@"fs.bin", FileMode.Create);
            Person p = new Person(tbName.Text, tbMobile.Text, tbEmail.Text, tbAddress.Text);
            arrlist.Add(p);
        ...
        {
            tbResult.Text = "";
            FileStream fs = new FileStream(@"fs.bin", FileMode.Open);
            BinaryFormatter bf = new BinaryFormatter();
